...
describe('weatherAPI', () => {
  ...
  describe('getForecastWeatherData', () => {
    it('should fetch and transform forecast weather data', async () => {
      ...
      expect(globalThis.fetch).toHaveBeenCalledWith(expect.stringContaining('forecast/daily'));
    ...
    it('should throw an error if the API call fails', async () => {
      ...
      await expect(getForecastWeatherData(10, 20, 4)).rejects.toThrow(
  ...
  describe('getHistoricWeatherData', () => {
    it('should fetch and transform historic weather data', async () => {
      ...
      expect(globalThis.fetch).toHaveBeenCalledWith(expect.stringContaining('history/hourly'));
    ...
    it('should throw an error if the API call fails', async () => {
      ...
      await expect(getHistoricWeatherData(10, 20, '2023-01-01', '2023-01-04')).rejects.toThrow(
