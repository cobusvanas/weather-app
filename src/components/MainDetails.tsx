        ...
        const fetchLocation = () => {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    ...
                    () => {
                        setError("We couldn’t access your location. Please enable location services in your browser and try again.");
                    }
                );
            } else {
                setError("Geolocation is not supported by your browser. Please use a different browser or device.");
            }
        };
        ...
        if (location) {
            const fetchWeatherData = async () => {
                try {
                    ...
                    setError("We couldn’t fetch the weather data. Please check your internet connection and try again.");
                }
            };
